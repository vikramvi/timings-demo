...
urlValue = "https://www.smava.de/"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//a/img[@alt="Smava Logo"]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaHomePage.yaml')
PERF = Perf(CONFIG_FILE)

# Refer to [POST] /v2/api/cicd/navtiming
...
if INJECT_CODE is not False:
    ...
    # Refer to Example Response (navtiming)
