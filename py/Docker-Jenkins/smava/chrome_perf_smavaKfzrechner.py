...
urlValue = "https://www.smava.de/landing/kfzrechner"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//*[@id="lp-header"]//h1/b[contains(text(),"Kredit")]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaKfzrechner.yaml')
