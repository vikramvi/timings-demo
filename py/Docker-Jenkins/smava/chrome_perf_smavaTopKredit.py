...
urlValue = "https://www.smava.de/landing/topkredit"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//h2[contains(text(), "Deutschlands") and contains(text(), "Kredit") ]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaTopKredit.yaml')
