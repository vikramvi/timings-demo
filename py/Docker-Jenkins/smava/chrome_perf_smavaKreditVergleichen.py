...
urlValue = "https://www.smava.de/landing/kredit-vergleichen.html"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//h4[text() = "Kostenlos und unverbindlich"]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaKreditVergleichen.yaml')
