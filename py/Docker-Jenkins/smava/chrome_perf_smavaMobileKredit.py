...
urlValue = "https://www.smava.de/kreditvergleich/lp/mobile-kredit.html"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//h1[text() = "Kreditvergleich:"]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaMobileKredit.yaml')
