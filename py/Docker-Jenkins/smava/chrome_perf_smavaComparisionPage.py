...
urlValue = "https://www.smava.de/pp/smava-kreditvergleich-responsive/comparison.html"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//*[@id="x-loan_selection"]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaHomePageComparisionPage.yaml')
