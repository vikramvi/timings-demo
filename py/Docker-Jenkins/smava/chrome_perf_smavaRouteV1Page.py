...
urlValue = "https://www.smava.de/kreditanfrage/kreditantrag.html?route=V1"
BROWSER.get(urlValue)


try:
    BROWSER.find_element_by_xpath('//h1[text() = "Unverbindlicher, kostenloser Kreditvergleich"]')
    print("FUNCTIONAL: Page looks good!")
except:
    print("FUNCTIONAL: Page sucks!")

# Setup custom config for PERF
CONFIG_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)),'', 'config_smavaRouteV1Page.yaml')
